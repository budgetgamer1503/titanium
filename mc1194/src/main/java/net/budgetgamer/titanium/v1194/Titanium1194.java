package net.budgetgamer.titanium.v1194;

import net.budgetgamer.titanium.config.ConfigManager;
import net.budgetgamer.titanium.core.CompatibilityManager;
import net.budgetgamer.titanium.v1194.rso.RSOOptionRegister;
import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.loader.api.FabricLoader;

public class Titanium1194 implements ClientModInitializer {
